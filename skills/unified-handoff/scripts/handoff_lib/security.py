"""Validation helpers for completeness, secrets, and file references."""
...
from .constants import BLOCKING_SECTIONS, BUILTIN_SECRET_PATTERNS, PLACEHOLDER_PATTERN_STRINGS

PLACEHOLDER_PATTERNS = tuple(re.compile(pattern, re.IGNORECASE) for pattern in PLACEHOLDER_PATTERN_STRINGS)
...
def scan_secrets(
    ...
    warnings: List[str] = []
    patterns = list(BUILTIN_SECRET_PATTERNS)
